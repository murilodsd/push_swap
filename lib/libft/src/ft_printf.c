...
/*   Updated: 2024/06/21 16:41:21 by mde-souz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_print_args(va_list args, t_params params)
{
...
int	ft_loop_format(const char *format, t_params *params, va_list args)
{
	int	count;
...
int	ft_printf(const char *format, ...)
{
	...
	count = ft_loop_format(format, &params, args);
	va_end(args);
	return (count);
}
/* #include <stdio.h>
